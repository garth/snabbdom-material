    ...
    <div style={{ margin: '16px 0' }}>
      <Row>
        <Col type='sm-offset-1 sm-2'>
          <Paper elevation={1} style={{ paper: { margin: '16px 0' } }}>Paper 1</Paper>
        </Col>
        <Col type='sm-2'>
          <Paper elevation={2} style={{ paper: { margin: '16px 0' } }}>Paper 2</Paper>
        </Col>
        <Col type='sm-2'>
          <Paper elevation={3} noPadding style={{ paper: { margin: '16px 0' } }}>Paper 3</Paper>
        </Col>
        <Col type='sm-2'>
          <Paper elevation={4} style={{ paper: { margin: '16px 0' } }}>Paper 4</Paper>
        </Col>
        <Col type='sm-2'>
          <Paper elevation={5} style={{ paper: { margin: '16px 0' } }}>Paper 5</Paper>
        </Col>
      </Row>
